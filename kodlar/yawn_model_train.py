...
# AYARLAR
# =============================
BASE_DATASET = r"D:/Surucu_Projesi/processed_dataset/yawn"
IMG_SIZE = (224, 224)
BATCH_SIZE = 32
EPOCHS = 25   # Yawn modelini biraz daha uzun eğit
LR = 1e-4
OUTPUT_MODEL = r"D:/Surucu_Projesi/models/yawn_model.h5"
...
print(f"🎯 Yawn Model Test Accuracy: {test_acc*100:.2f}%")

# Model kaydet
model.save(OUTPUT_MODEL)
print(f"💾 Yawn Model kaydedildi: {OUTPUT_MODEL}")
